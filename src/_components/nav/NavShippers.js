        ...
        <MenuList borderRadius='1rem'>
          <Box py='6' px='8' display='flex'>
            <Box mr='4'>
              ...
              <MenuItemL2 href='/service/food-beverage' label='Food & Produce'>For 33 years we have set the benchmark for reliability in refrigerated transportation</MenuItemL2>
