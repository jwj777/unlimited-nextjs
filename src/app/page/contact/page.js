...
export async function generateMetadata({ params, searchParams }, parent) {
  ...
  let pageMeta = await fetch(`https://unlimited-strapi-h4fgb.ondigitalocean.app/api/basic-pages?filters[slug][$eq]=contact-data&populate=*`).then((res) => res.json())
...
async function getPageData() {
  try {
    // const slug = params.slug;
    const response = await fetch(`https://unlimited-strapi-h4fgb.ondigitalocean.app/api/basic-pages?filters[slug][$eq]=contact-data`, { next: { revalidate: 20 } });
